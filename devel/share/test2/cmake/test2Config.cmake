...
if("TRUE" STREQUAL "TRUE")
  set(test2_SOURCE_PREFIX /home/prtty/test_ws/src/test2)
  set(test2_DEVEL_PREFIX /home/prtty/test_ws/devel)
  set(test2_INSTALL_PREFIX "")
  set(test2_PREFIX ${test2_DEVEL_PREFIX})
else()
  set(test2_SOURCE_PREFIX "")
  set(test2_DEVEL_PREFIX "")
  set(test2_INSTALL_PREFIX /home/prtty/test_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'prtty <prtty@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/prtty/test_ws/src/test2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/prtty/test_ws/devel/lib;/home/prtty/test_ws/devel/lib;/opt/ros/melodic/lib)
